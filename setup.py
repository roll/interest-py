...
long_description = 'Interest is a REST framework on top of asyncio and aiohttp.'
...
setup(
    ...
    classifiers=[],       
    description='Interest is a REST framework on top of asyncio and aiohttp.',
    ...
    install_requires=['sugarbowl', 'aiohttp>=0.14'], 
    packages=packages,
    platforms=['Unix'],
