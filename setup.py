...
long_description = 'Interest is a resource based web framework on top of asyncio and aiohttp.'
...
setup(
    ...
    classifiers=[],       
    description='Interest is a resource based web framework on top of asyncio and aiohttp.',
